...
export default function MonthlyAllowanceScreen() {
    ...
    const [result, setResult] = useState<MonthlyAllowanceCalculationResult | null>(null);
    ...
    const handleCalculate = () => {
        ...
        const calculation = calculateMonthlyAllowanceFromPeriodData(
            parsedStart,
            parsedEnd,
            periodBuckets,
            maritalStatus,
                        ...
                        <Card.Content style={styles.cardContent}>
                                ...
                                <View style={styles.headerText}>
                                    ...
                                    <ThemedText type="small" style={[styles.pageDescription, { color: theme.textSecondary }]}>
                                        {shouldShowMaritalStatus
                                            ? 'برای محاسبهٔ بن ماهیانه، بازهٔ زمانی مورد نظر و وضعیت تأهل را انتخاب کنید.'
                                            : 'برای محاسبهٔ بن ماهیانه، بازهٔ زمانی موردنظر را انتخاب کنید.'}
                                    </ThemedText>
                                </View>
                            </View>
                            ...
                            <View style={[styles.formulaBox, { backgroundColor: theme.surfaceVariant, borderColor: theme.border }]}>
                                ...
                                <ThemedText type="small" style={[styles.formulaValue, { color: theme.text }]}>
                                    تعداد ماه کارکرد در هر سال × بن ماهیانه همان سال
                                </ThemedText>
                            </View>
                                                    ...
                                                    >
                                                        ...
                                                        <View style={styles.breakdownDetailGrid}>
                                                            ...
                                                            <View style={[styles.breakdownDetailBox, { backgroundColor: theme.surfaceVariant, borderColor: theme.border }]}>
                                                                ...
                                                                <ThemedText type="smallBold" style={[styles.detailValue, { color: theme.text }]}>
                                                                    {item.monthlyAllowance != null ? toPersianDigits(formatCurrency(item.monthlyAllowance)) : '-'}
                                                                </ThemedText>
                                                            </View>
