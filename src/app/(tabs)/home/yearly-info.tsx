...
function PeriodCardLocal({
  ...
  const getPeriodDetailRows = (periodItem: PeriodRecord): PeriodDetailRow[] => [
    ...
    { kind: 'row', label: 'حق عائلگی', value: periodItem.marital_allowance, currency: true },
    { kind: 'row', label: 'حق اولاد', value: periodItem.child_allowance, currency: true },
    { kind: 'row', label: 'حداقل پاداش ماهانه', value: periodItem.min_monthly_bonus, currency: true },
    { kind: 'row', label: 'حداکثر پاداش ماهانه', value: periodItem.max_monthly_bonus, currency: true },
