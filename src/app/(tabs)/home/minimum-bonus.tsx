...
import {
    ...
    parseDateInput,
    type MinimumBonusAndEntitlementCalculationResult,
    type SalaryPeriodBucket,
} from '@/utils/salary-calculation';

export default function YearlyBonusScreen() {
    ...
    const [result, setResult] = useState<MinimumBonusAndEntitlementCalculationResult | null>(null);
    ...
    const handleCalculate = () => {
        ...
        const calculation = calculateMinimumBonusAndEntitlementFromPeriodData(
            parsedStart,
            parsedEnd,
            periodBuckets,
            includeDaysCovered,
                                        ...
                                        <View style={styles.summaryBoxHeader}>
                                            <View style={[styles.summaryBoxContent, { backgroundColor: theme.surface, borderColor: theme.border }]}>
                                                <ThemedText type="small" style={[styles.summaryLabel, { color: theme.textSecondary }]}>
                                                    مبلغ کل حداقل عیدی و پاداش استحقاقی
                                                </ThemedText>
